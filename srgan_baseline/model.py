...
class Discriminator(nn.Module):
    def __init__(self) -> None:
        ...
        self.features = nn.Sequential(
            # input size. (3) x 96 x 96 / 3x32x32
            nn.Conv2d(3, 64, (3, 3), (1, 1), (1, 1), bias=True),
            nn.LeakyReLU(0.2, True),
            # state size. (64) x 48 x 48/ 64x16x16
            ...
            nn.BatchNorm2d(128),
            nn.LeakyReLU(0.2, True),
            # state size. (128) x 24 x 24 / 128x8x8
            ...
            nn.BatchNorm2d(256),
            nn.LeakyReLU(0.2, True),
            # state size. (256) x 12 x 12 / 256x4x4
            ...
            nn.BatchNorm2d(512),
            nn.LeakyReLU(0.2, True),
            # state size. (512) x 6 x 6 / 512 x 2x2
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        if x.shape[2] == 96 and x.shape[3] == 96:
            out = self.features(x)
